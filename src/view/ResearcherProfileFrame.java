...
public class ResearcherProfileFrame extends JFrame {
	...
	public void addFollower(String name) {
		for (int i = 0; i < followersListModel.size(); i++) {
			if (followersListModel.get(i).equals(name)) {
				JOptionPane.showMessageDialog(this, "The researcher is already being followed.");
				return;
			}
		}
		JOptionPane.showMessageDialog(this, "The researcher is followed.");
		followersListModel.addElement(name);
	}
	...
	public void removeFollowing(String name) {
		for (int i = 0; i < followersListModel.size(); i++) {
			if (followersListModel.get(i).equals(name)) {
				JOptionPane.showMessageDialog(this, "The researcher is unfollowed.");
				followersListModel.removeElement(name);
				return;
			}
		}
		JOptionPane.showMessageDialog(this, "You are not following this researcher already.");
	}
